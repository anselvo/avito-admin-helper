...
function getRegulations() {
    ...
    chrome.runtime.sendMessage({
            ...
            method: "GET",
            url: `${connectInfo.spring_url}/assistant/graphs/list`
        },
...
function gerRegulationHead(regulation) {
    ...
    chrome.runtime.sendMessage({
            action: 'XMLHttpRequest',
            method: "GET",
            url: `${connectInfo.spring_url}/assistant/graphs/head/`+ regulation.uuid
        },
...
function getVertexChildren(children) {
    ...
    chrome.runtime.sendMessage({
            action: 'XMLHttpRequest',
            method: "GET",
            url: `${connectInfo.spring_url}/assistant/list/?children=`+ children
        },
