    ...
    for (let i = 0; i < trList.length; ++i) {
        ...
        for (let j = 0; j < flagList.length; ++j) {
            ...
            if (flagId) {
                ...
                let flagLink = `https://adm.avito.ru/items/search?date=${formatDateStart}+-+${formatDateEnd}&location_id[]=${locationItemID}&cid[]=${categoryItemID}&price_min=${itemPriceMin}&price_max=${itemPriceMax}&${flagStatus}=${flagId}&percent_min=${percentMin}&percent_max=${percentMax}&params[${firstParam[0]}]=${firstParamMap}&s_type=2`;
